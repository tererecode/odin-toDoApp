...
function indexFinder(event) {
    ...
    let TargetObjIndex = _tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo.findIndex(obj => obj.uid == targetUID)
...
function taskUpdate(event) {
    ...
    _tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo[index].edit(index, titlePara)
    render(_tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo)
    console.log(_tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo)

}

function taskDelete(event) {
    let index = indexFinder(event)
    _tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo[index].remove(index)
    render(_tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo)
}

function createCard() {
    let newTaskObject = _tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.ToDo('', '', '', '', '', (0,uuid__WEBPACK_IMPORTED_MODULE_1__["default"])())
    console.log(newTaskObject)
    _tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo.push(newTaskObject)
    console.log(_tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo)
    render(_tasksModules_js__WEBPACK_IMPORTED_MODULE_0__.defaultToDo)
}
